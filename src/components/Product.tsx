      ...
      <div className="mt-4 mb-16">
        ...
        >
          {photos.map(({ photo }, index) => (
            <div
              key={index}
              className={`px-2 sm:px-1 py-1 ${index > 2 && 'hidden sm:block'}`}
            >
              <Image
                src={photo.url}
                width={photo.width}
        ...
        <div className="text-center">
          <button
            ...
            className="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-blue-700 uppercase transition bg-transparent border-2 border-blue-700 rounded-full ripple hover:bg-blue-100 focus:outline-none waves-effect"
          >
            See More
          </button>
        </div>
